...
void cubeError() {
  float delayval = (520 / 33);
  for (int i = 0; i < (NUMPIXELS / 2); i++) {
    pixels.setPixelColor(i, pixels.Color(150, 150*.4516, 0));
    pixels.setPixelColor(65-i, pixels.Color(150, 150*.4516, 0));
    pixels.show();
    wait(delayval);
    pixels.setPixelColor(i, pixels.Color(0, 0, 0));
    pixels.setPixelColor(65-i, pixels.Color(0, 0, 0));
  }
